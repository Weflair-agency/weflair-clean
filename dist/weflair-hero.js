(() => {
  ...
  const ROUTES = {
    ...
    resourcesChecklists: "/tools.html?topic=checklists",
  ...
  const CONTENT = {
    ...
    nav: {
      ...
      resources: [
        ...
        ["Checklists", "Performance checklists to audit and optimize your growth."],
    ...
    footer: {
      ...
      resources: {
        ...
        links: [
          ...
          { label: "Checklists", href: ROUTES.resourcesChecklists },
