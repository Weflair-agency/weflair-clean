...
<head>
  ...
  <title>Outbound & GTM Engineering — WeFlair</title>
...
<main class="main">
  <section class="pd-hero-sec">
    <div class="pd-hero__inner">
      <div class="eyebrow" style="margin-bottom:1.5rem; justify-content:center;">
        ...
        <p class="eyebrow__p">Outbound & GTM</p>
      </div>
      <h1 class="pd-hero__title">Replace your SDRs with <span style="color:#3eff68">systemic velocity.</span></h1>
      <p class="pd-hero__sub">Manual prospecting is dead. We build automated data-waterfalls, hyper-personalized email architectures, and rigorous outbound playbooks that fill AE calendars without burning headcount.</p>
      <div style="margin-top:2rem;">
        <a href="../contact.html" class="btn w-inline-block weflair-btn weflair-btn--primary">
          <div class="btn__bg"></div>
          <div class="btn__text"><span class="btn__span">Book A GTM Audit</span></div>
        </a>
      </div>
    </div>
  </section>
  ...
  <section class="pd-bleed-sec">
    <div class="weflair-bleed-box">
      <h2>Your $80K SDR is copying and pasting from Apollo.</h2>
      <p>B2B outbound has completely changed. If you are paying humans to scrape data and guess emails, your CAC is fatally flawed. We engineer technical outbound systems that scrape buyer intent data at scale and automatically weave it into hyper-personalized, high-deliverability sequences.</p>
    </div>
  </section>
  ...
  <section class="pd-transform-sec">
    <div class="pd-transform-inner">
      <div class="pd-transform-head">
        <h2>The Sales Paradigm Shift</h2>
      </div>
      <div class="pd-transform-grid">
        <div class="transform-col transform-col--bad">
          <h3><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> Legacy Outbound</h3>
          <ul class="transform-list">
            <li><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg> Manual list building.</li>
            <li><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg> Spray and pray templates with your domain burning.</li>
            <li><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg> Relying entirely on entry-level reps.</li>
          </ul>
        </div>
        <div class="transform-col transform-col--good">
          <h3><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> WeFlair GTM Engine</h3>
          <ul class="transform-list">
            <li><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> IP-level intent data scraping.</li>
            <li><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> AI-driven personalized 1-to-1 cadences at scale.</li>
            <li><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> Automated multi-thread architectures.</li>
          </ul>
        </div>
      </div>
    </div>
...
fs.writeFileSync(path.join(__dirname, 'services', 'outbound-gtm.html'), pageHtml);
console.log('Successfully built services/outbound-gtm.html');
