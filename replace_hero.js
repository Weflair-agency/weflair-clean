...
const oldHeroStart = \<p class="eyebrow__p">Paid Media &amp; Performance</p>
          </div>
          <h1 class="sv-hero__title">
            Turn ad spend into <em>compounding revenue.</em>
          </h1>
          <p class="sv-hero__sub">
            We don't just run ads. We build full-funnel paid systems that tie
            every impression to pipeline and revenue — for B2B and ecommerce
            brands that refuse to guess.
          </p>
...
const targetEnd = html.indexOf(oldHeroEnd, targetStart);
          ...
          <div class="cro-diagram">
            ...
            <div class="cro-diagram__container">
              ...
              <div class="cro-diagram__col cro-diagram__col--center">
                <a href="#audit" class="cro-diagram__btn btn w-inline-block weflair-btn">
                  <div class="btn__bg" style="background:#F97316;"></div>
                  <div class="btn__text">
                    <span class="btn__span" style="color:#111;">Get Your CRO Audit</span>
                  </div>
                </a>
              </div>
...
\;
  ...
  console.log('Could not find old hero segment.');
}
